...
parser = argparse.ArgumentParser(description="Read a file and process its contents")    #Create an ArgumentParser object
parser.add_argument("--source", help="Path to the input file")    # Add a command-line argument for the input file
parser.add_argument("--type", help="Type to filter")    # Add a command-line argument for the type
parser.add_argument("--attribute", help="Attribute name")    # Add command-line arguments for attribute
parser.add_argument("--value", help="Attribute value")    # Add command-line arguments for value
